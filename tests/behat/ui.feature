...
Feature: Codechecker UI works as expected
  ...
  Scenario Outline: Verify that specified paths are checked
    ...
    Examples:
      ...
      | local/codechecker/rules/moodle/tests/fixtures/files/moodleinternal/problem.php | Files found: 1                     | Invalid path   |
      | local/codechecker/rules/moodle/tests/fixtures/files/moodleinternal/problem.php | Total: 2 error(s) and 1 warning(s) | Well done!     |
      | local/codechecker/rules/moodle/tests/fixtures/files/moodleinternal/problem.php | Inline comments must end           | Well done!     |
      | local/codechecker/rules/moodle/tests/fixtures/files/moodleinternal/problem.php | Expected MOODLE_INTERNAL check     | Well done!     |
  ...
  Scenario Outline: Verify that specified exclusions are performed
    ...
    Examples:
      ...
      | local/codechecker/rules/moodle/tests  | */tests/fixtures/* | Files found: 8                | Invalid path |
      | local/codechecker/rules/moodle/tests  | */tests/fixtures/* | moodlestandard_test.php       | Invalid path |
      | local/codechecker/rules/moodle/tests/ | *PHPC*, *moodle_*  | Files found: 70               | Invalid path |
      | local/codechecker/rules/moodle/tests/ | *PHPC*, *moodle_*  | Line 1 of the opening comment | moodle_php   |
      | local/codechecker/rules/moodle/tests/ | *PHPC*, *moodle_*  | Inline comments must end      | /phpcompat   |
      | local/codechecker/rules/moodle/tests/ | *PHPC*, *moodle_*  | Inline comments must end      | /phpcompat   |
      | local/codechecker/rules/moodle/tests/ | *moodle_*          | fixtures/phpcompat            | /moodle_php  |
  ...
  Scenario: Verify that the warnings toggle has effect
    Given I log in as "admin"
    And I navigate to "Development > Code checker" in site administration
    And I set the field "Path(s) to check" to "local/codechecker/rules/moodle/tests/fixtures/squiz_php_commentedoutcode.php"
  ...
  Scenario: Optionally output PHPCS standard
    Given I log in as "admin"
    And I navigate to "Development > Code checker" in site administration
    And I set the field "Path(s) to check" to "local/codechecker/rules/moodle/tests/fixtures/files/moodleinternal/problem.php"
