...
/**
 * Custom ScopeIndent Sniff to avoid T_OPEN_TAG and T_CLOSE_TAG to reset indent.
 *
...
class moodle_Sniffs_WhiteSpace_ScopeIndentSniff extends Generic_Sniffs_WhiteSpace_ScopeIndentSniff {
     ...
     * @var bool
     */
    public $resetIndentationWithOpenClose = false;

    /**
     * Processes this test, when one of its tokens is encountered.
     *
     * Note we are duplicating the whole process() method of the Generic sniff
     * just to introduce our resetIndentationWithOpenClose check in order to
     * avoid indentation to be reset with T_OPEN_TAG and T_CLOSE_TAG. There is not
     * any other way to avoid that in the parent class and it's the way we do it, with
     * structure indentation "persisting" over open and close tags. See CONTRIB-5732.
     * We'll be able to kill all this dupe if this PR is accepted upstream:
     * https://github.com/squizlabs/PHP_CodeSniffer/pull/796
     *
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        for ($i = ($stackPtr + 1); $i < $phpcsFile->numTokens; $i++) {
            ...
            if ($tokens[$i]['code'] === T_OPEN_TAG
                ...
                if (!$this->resetIndentationWithOpenClose) {
